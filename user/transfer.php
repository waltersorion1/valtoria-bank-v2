...
<?php if ($result): ?><div class="notice success">Transfer completed. Reference <strong><?= e($result['reference']) ?></strong>.</div><?php endif ?>
<div class="app-grid">
...
<div class="actions"><form method="post"><?= csrfField() ?><input type="hidden" name="action" value="confirm"><button class="button button-primary">Confirm transfer</button></form><form method="post"><?= csrfField() ?><input type="hidden" name="action" value="cancel"><button class="button button-secondary">Cancel</button></form></div>
